...
set(MSG_I_FLAGS "-Iplanning:/home/student/ERC-hackathon/hackathon/src/planning/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/student/ERC-hackathon/hackathon/src/planning/msg/array.msg" NAME_WE)
add_custom_target(_planning_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "planning" "/home/student/ERC-hackathon/hackathon/src/planning/msg/array.msg" ""
)
...
_generate_msg_cpp(planning
  "/home/student/ERC-hackathon/hackathon/src/planning/msg/array.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planning)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/planning\")")
  # install generated code
  install(
